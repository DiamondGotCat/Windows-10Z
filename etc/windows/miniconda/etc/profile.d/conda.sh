export CONDA_EXE='/home/diamondgotcat/windows-10z/includes.chroot/etc/windows/miniconda/bin/conda'
export _CE_M=''
export _CE_CONDA=''
export CONDA_PYTHON_EXE='/home/diamondgotcat/windows-10z/includes.chroot/etc/windows/miniconda/bin/python'
