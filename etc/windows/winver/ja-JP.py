...
class WinverWindow(QWidget):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Windows のバージョン情報")
        ...
        content_text = (
            ...
            "バージョン 1.0 (OSビルド 129)<br>"
            "© 2019 Microsoft Corporation. All rights reserved.<br><br>"
            "Windows 10Z Pro オペレーティング システムとユーザー インターフェイスは、米国およびその他の国/地域の商標およびそのほかの知的所有権によって保護されています。<br><br>"
            "この製品は<a href='https://www.microsoft.com/ja-jp/useterms'>マイクロソフト ソフトウェア ライセンス条項</a>の条件に基づいて次の方にライセンスされています。<br>"
            "<b>DiamondGotCat</b>"
            "</div>"
        )
